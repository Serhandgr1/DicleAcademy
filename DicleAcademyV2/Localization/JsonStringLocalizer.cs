...
namespace DicleAcademyV2.Localization
{
        ...
        public class JsonStringLocalizer : IStringLocalizer
        {
            ...
            {
                string filePath = $"Resources/{Thread.CurrentThread.CurrentUICulture.Name}.json";
            ...
            {
                string relativeFilePath = $"Resources/{Thread.CurrentThread.CurrentUICulture.Name}.json";
